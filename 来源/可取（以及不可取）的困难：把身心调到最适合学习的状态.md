---
type: source
aliases: [Desirable Difficulties lesson, 可取困难]
created: 2026-05-15
updated: 2026-05-15
sources: 1
tags: [板块/教育与学习]
...
## 一句话总结
学习不靠「吃苦」而靠「可取困难」：把对学习有益的内在阻力（提取、间隔、交错）和把身心调到最适合学习状态的方法（合适唤醒度、运动、睡眠、具身认知）结合起来，让自己像运动员一样灵动而非僵化。

## 核心论点
- 「没苦硬吃」是用神经系统的磨损冒充认知能力的增长；中国青少年抑郁高发与无价值的学习压力相关，而双减、充足睡眠反而改善心理与成绩。
- 微观上一个知识点入脑要过两关：**能不能学进去**（毫秒尺度，大脑判断「新不新、值不值得关心、有没有奖励」，多巴胺让海马体开门——所以兴趣/好奇心是最好的老师）；**能不能理解**（由 [[唤醒度]] 调节，需中等唤醒——太低心不在焉，太高紧张慌乱，高压会打击前额叶，「恐惧制造服从而非理解」）。
- 最有利于学习的情绪配方：**安全感打底 + 好奇心点火 + 适度压力提速**。
- 核心工具 [[可取困难]]（[[罗伯特·比约克]] 1990s 提出）：必须把 [[表现与学习的区分|「表现」和「学习」]] 分开；阻力会让短期表现变差，但让长期记忆与迁移能力变强。三个操作心法：[[提取练习]]、[[间隔学习]]、[[交错学习]]。可取困难是「在内在负荷范围内折腾」，不可取困难是「从外部施加无价值的 [[外在负荷]]」。
- 提升学习状态的两个科学方法：**急性运动**（20 分钟中等强度→提高唤醒度+乳酸跨血脑屏障供能+刺激 BDNF「大脑化肥」，效应不大但可靠）；**睡眠**（类淋巴系统清理代谢垃圾、海马体把短期记忆转写为长期记忆；青少年需 8–10 小时，睡眠是学习的一道工序而非懒惰）。
- [[具身认知]]：身体动作、姿势、触觉、空间定位都参与大脑建模——四个心法：动手做动作、手写、读纸质书、想不出就站起来走几步。

## 关键概念
- [[可取困难]]（Desirable Difficulties）— 本讲核心工具
...
- [[唤醒度]]（arousal）
- [[表现与学习的区分]]
- 关联已有：[[刻意练习]]、[[学习区]]、[[认知负荷理论]]、[[内在负荷]]、[[外在负荷]]、[[直接教学]]、[[专家逆转效应]]、[[指导淡出]]、[[工作记忆]]

## 引用人物与著作
- [[罗伯特·比约克]]（Robert Bjork，UCLA 心理学家，可取困难提出者）
- [[伊丽莎白·比约克]]（Elizabeth Bjork，与 Robert 合作「表现 vs 学习」洞见）
- [[万维钢]]（主讲）
- 脚注均为期刊论文（Bjork 1994/2011、Mueller & Oppenheimer 2014、Oppezzo & Schwartz 2014 等），未单独建著作页。

## 与其他课程的连接
- 上一讲 [[默会知识：（但愿）AI 永远都不可能替代的技能|默会知识]] 提到 [[具身认知]]，本讲展开为四个学习心法。
- 「在 [[学习区]] 练习才叫学习」——本讲是 [[刻意练习]] 的微观神经版补充。
- 「先猜后学」往往不如直接教学，呼应 [[认知负荷理论]] 与 [[专家逆转效应]]。
- 可取/不可取困难 ↔ [[内在负荷]] / [[外在负荷]] 的对照。
...
> 来源：https://www.dedao.cn/course/article?id=AgOBQ46R1rnXRQomwPJdLzGqEZ3aY7
> 出处：[[现代思维工具100讲]] · 15分05秒
...
![](assets/可取（以及不可取）的困难：把身心调到最适合学习的状态/01.png)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026051422/1909937217764365408/051422.png -->
...
![](assets/可取（以及不可取）的困难：把身心调到最适合学习的状态/02.jpeg)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026051422/1909937171593501632/051422.jpeg -->

![](assets/可取（以及不可取）的困难：把身心调到最适合学习的状态/03.jpeg)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026051422/1909936840878922688/051422.jpeg -->
