...
## 一句话总结
[[OODA 环]] 不是反应快，而是换脑快——观察、定向、决策、行动循环往复，谁的认知地图刷新率更高，谁就掌握主动。

## 核心论点
- 实战不会留时间做调研，但手忙脚乱也是大忌——OODA 提供有章法的应对。
- 四步循环：[[观察]]（抓变化、抓异常）→ [[定向]]（重新判断"这是什么局"）→ [[决策]]（选最值得下注的假设）→ [[行动]]（逼现实表态）。
- 最关键是第二个 O：[[定向]]。博伊德称之为 Schwerpunkt（阵眼）。
- 定向 = 改 [[叙事]] = 给事件定性，重选模型；它由遗传背景、文化传统、既往经验和正在展开的情境共同塑造。
- 用现代认知科学看：观察+定向 = [[预测处理]] 的预测误差 → 模型更新；决策+行动 = [[主动推断]]——带着模型行动，用行动采样世界。
- 博伊德升级版：D 解释为「假设」，A 解释为「压力测试」。
- 不是赢在最后一拳，而是赢在误导对方的 OODA。
- 案例：中途岛海战（[[切斯特·尼米兹]] vs [[南云忠一]]）；Zara 的高频 OODA；乌克兰前线的 AI 无人机迭代。
- 现代战争中决策速度本身就是武器系统；AI 时代赢家是学习链最短的一方——美军称作 [[决策优势]]。
- 日常应用：考差不要直接刷题，先定向；工作数据下滑先做最小探针；夫妻吵架先看对方的"局"是什么。
...
## 引用人物与著作
- [[万维钢]] — 课程主理人
- [[博伊德]] — John R. Boyd；OODA 提出者
- [[切斯特·尼米兹]] — 中途岛美军指挥官
- [[南云忠一]] — 中途岛日军指挥官，反面教材

## 与其他课程的连接
- 是 [[现代思维工具100讲]] 「决策与行动」板块最后一讲。
- 与 [[自由能原理：活着就是对齐]]：OODA 是主动推断的战术化版本。
- 与 [[叙事：这个宇宙的第一性原理]]：定向 = 改叙事。
- 与 [[认知解耦：三步调节负面情绪]]：定向需要先把"心中的剧本"和"眼前的事实"拆开。
- 与 [[ICAP 框架：最高效的学习方法]]：每轮 OODA 是一次小型 C+I（建构+互动）。
...
> 来源：https://www.dedao.cn/course/article?id=zYo2GPNq4W8VEbwm6mJejyRBZbnw0d
> 出处：[[现代思维工具100讲]] · 14分05秒　转述：怀沙AI
...
![](assets/OODA 环：不是反应快，而是换脑快/01.png)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026050522/1909103276847313560/050522.png -->
...
![](assets/OODA 环：不是反应快，而是换脑快/02.jpeg)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026050522/1909103298324244232/050522.jpeg -->
...
![](assets/OODA 环：不是反应快，而是换脑快/03.png)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026050522/1909103335903110920/050522.png -->
...
![](assets/OODA 环：不是反应快，而是换脑快/04.png)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026050522/1909103370262812752/050522.png -->
...
![](assets/OODA 环：不是反应快，而是换脑快/05.jpeg)
<!-- src: https://piccdn2.umiwi.com/uploader/image/ddarticle/2026050522/1909103092163719832/050522.jpeg -->
