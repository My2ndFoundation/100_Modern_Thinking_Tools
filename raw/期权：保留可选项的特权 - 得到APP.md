---
title: "期权：保留可选项的特权 - 得到APP"
source: "https://www.dedao.cn/course/article?id=YB83z6N9dqxVyPnBzdK7ZMvy0GQDO5"
author:
  - "[[万维钢·现代思维⼯具100讲]]"
published:
created: 2026-05-08
...
![](https://piccdn2.umiwi.com/uploader/image/ddarticle/2026042622/1908268154817393304/042622.png)
...
美国战略管理学者丽塔·麦格拉思（Rita Gunther McGrath） —— 她是“真实期权战略（real options strategy）”研究的重要推动者 —— 跟合作者在 2004 年发表的一篇论文 \[1\] 中提出： 期权价值要成立，得满足两个条件 —— 第一，未来存在多个可能路径；第二，你对其中某个结果拥有专有进入权。

![](https://piccdn2.umiwi.com/uploader/image/ddarticle/2026042622/1908268318025099016/042622.png)
...
2015年，贝佐斯在致亚马逊股东的信中提出，决策要分成两类：一类是「双向门（Two-way doors）」，也就是可逆的选择；另一类是「单向门（One-way doors）」，也就是不可逆的选择 \[6\]。他的洞见是：对于双向门，一定要快过：你需要快速知道这件事行不行，不行还可以马上撤回来；而对于单向门，因为你没有反悔的权利，就必须三思而行。
...
![](https://piccdn2.umiwi.com/uploader/image/ddarticle/2026042619/1908256027976144976/042619.jpeg)
...
1.期权本来是个金融概念，是你有权在一定期限内，以约定价格买入或者卖出某个标的，但你没有义务必须这么做。期权就是你的一个可选项：它只是权利，不是义务。  
2.一种看涨期权叫「优先受让权」，「最佳替代方案（BATNA）」是一种看跌期权。「对赌协议」是另一种期权，它把一方的权利变成另一方的义务，适用于双方对未来的看法有很大分歧的局面：一方看涨一方看跌。  
3.很多期权是有持有成本的，而且会过期。金融理论告诉我们：市场的波动性越大，期权的价值就越高；到期时间越短，期权的价值就越低。